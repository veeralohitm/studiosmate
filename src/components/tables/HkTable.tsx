...
const vacantRooms: Room[] = [
    { id: 1, roomId: "101", roomType: "Single", lastCleaned: "2024-03-01",checkOutDate: "2024-03-15", status:"Under Progress", cleanedby: "John" },
    { id: 2, roomId: "102", roomType: "Double", lastCleaned: "2024-02-20",checkOutDate: "2024-03-15",status:"Checked Out", cleanedby: "Doe" },
    { id: 3, roomId: "103", roomType: "Suite",  lastCleaned: "2024-01-15",checkOutDate: "2024-03-15",status:"Maintanance Issue", cleanedby: "Jack" },
  ];
  const roomTypes = ["All", "Single", "Double", "Suite"];
const ITEMS_PER_PAGE = 2;
export default function HkTable() {
        ...
        <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
          {paginatedData.map((room, index) => (
            <TableRow key={room.id}>
               ...
               <TableCell className="px-5 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400">{room.cleanedby}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
